...
public class TelescopeSim extends Telescope {
  ...
  ElevatorSim teleSim = new ElevatorSim(LinearSystemId.createElevatorSystem(elevatorMotor, ELEVATOR_MASS, 0.15, ELEVATOR_GEAR_RATIO), elevatorMotor, MIN_RELATIVE_HEIGHT, MAX_HEIGHT, false, MIN_RELATIVE_HEIGHT);
  double output = 0;
