...
/**
 * (edited to allow changing constants at runtime for controls hackery)
 * A helper class that computes feedforward outputs for a simple elevator (modeled as a motor acting
 * against the force of gravity).
 */
public class ElevatorFeedforwardSettable implements ProtobufSerializable, StructSerializable {
   ...
   */
  public ElevatorFeedforwardSettable(double ks, double kg, double kv, double ka, double dtSeconds) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
   ...
   * @throws IllegalArgumentException for ka &lt; zero.
   */
  public ElevatorFeedforwardSettable(double ks, double kg, double kv, double ka) {
   ...
   * @throws IllegalArgumentException for kv &lt; zero.
   */
  public ElevatorFeedforwardSettable(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
