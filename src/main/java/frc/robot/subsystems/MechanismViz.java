...
public class MechanismViz extends SubsystemBase {
  ...
  public Transform3d[] getComponentPosesFor(double telescopeLength, Rotation2d pivotAngle, Rotation2d wristAngle) {
    ...
    Transform3d stage1Extension = new Transform3d(0, 0, telescope.getExtension()/2.0, new Rotation3d());
    Transform3d stage2Extension = new Transform3d(0, 0, telescope.getExtension()/2.0, new Rotation3d());
  ...
  public void periodic() {
    ...
    Transform3d[] setpointPoses = getComponentPosesFor(telescope.getGoalExtension(), pivot.getGoalAngle(), wrist.getTargetAngle());
