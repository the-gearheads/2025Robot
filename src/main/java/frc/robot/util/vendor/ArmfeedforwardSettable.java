...
/**
 * (modified to allow changing constants at runtime for controls hackery)
 * A helper class that computes feedforward outputs for a simple arm (modeled as a motor acting
 * against the force of gravity on a beam suspended at an angle).
 */
public class ArmfeedforwardSettable implements ProtobufSerializable, StructSerializable {
   ...
   */
  public ArmfeedforwardSettable(double ks, double kg, double kv, double ka, double dtSeconds) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
   ...
   * @throws IllegalArgumentException for ka &lt; zero.
   */
  public ArmfeedforwardSettable(double ks, double kg, double kv, double ka) {
   ...
   * @throws IllegalArgumentException for kv &lt; zero.
   */
  public ArmfeedforwardSettable(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
